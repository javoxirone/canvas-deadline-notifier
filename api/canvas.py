...
class CanvasAPI:
    ...
    def get_all_assignments_of_single_course(self, course_id: int) -> List[Dict]:
        ...
        assignments = self.request_endpoint(
            "courses/" + str(course_id) + "/assignments/", {"bucket": "unsubmitted"}
        )
        ...
        for course in course_list:
            ...
            for assignment in assignment_list:
                ...
                if self.is_active_assignment(assignment):
                    ...
                    assignment_list_with_required_fields.append(
                        self.extract_required_fields_from_assignment(
    ...
    def extract_required_fields_from_assignment(
        self, course_name: str, assignment_data: Dict
    ) -> AssignmentInfo:
        """
        ...
        context = {
            ...
            "assignment_due_at": self.handle_assignment_deadline(
    ...
    def is_active_assignment(self, assignment: Dict) -> bool:
        ...
        is_active = (
            assignment["due_at"]
            and self.format_deadline(assignment["due_at"]) > datetime.now()
        )
